...
void VertexArrayObject::build(const Vertex3TexList &vertices, const IndexList &indices)
{
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(Vertex3Tex), (void*)0);
    glEnableVertexAttribArray(0);
    
    // kaplama bilgileri belirtiliyor
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(Vertex3Tex), (void*)(3*sizeof(float)));
...
void VertexArrayObject::build(const Vertex3ColorList &vertices, const IndexList &indices)
{
    glGenVertexArrays(1, &m_VaoId); 
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(Vertex3Color), (void*)0);
    glVertexAttribPointer(1, 4, GL_FLOAT, GL_FALSE, sizeof(Vertex3Color), (void*)(sizeof(glm::vec3)));
